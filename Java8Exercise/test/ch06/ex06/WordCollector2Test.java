...
public class WordCollector2Test {
	...
	public void setUp(){
		...
		files = new HashSet<>();
		files.add(new File("test/ch06/ex06/text1"));
		files.add(new File("test/ch06/ex06/text2"));		
		files.add(new File("test/ch06/ex06/text3"));
		files.add(new File("test/ch06/ex06/text4"));		
